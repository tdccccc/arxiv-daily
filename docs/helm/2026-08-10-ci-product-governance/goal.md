...
- [x] Email relay 与 VS Code companion 各有独立 CI，使用自身依赖/版本策略验证构建、测试和部署 dry-run。
- [x] 显式 product-unit inventory 能拒绝未经分类的新 package/service/extension，所有门禁和技术报告同步。
...
3. P3 — Relay、companion 与全部产品单元进入独立 CI 和显式治理 — status: done
