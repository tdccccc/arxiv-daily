...
| Hosted | **官方代发** | Official delivery (arXiv Daily) |
...
| **官方代发** | 验证邮箱后由 arXiv Daily 发送（需联网，由项目提供） |
...
**Implementation now:** only **自己发送** is live. **官方代发** is documented as planned; UI may show the name as “规划中 / Coming soon” without enabling it (docs-only alignment phase — 2026-07-27).
...
| Email proof | **Magic link** in email (2026-07-27): user enters To → receives link → binds address |
